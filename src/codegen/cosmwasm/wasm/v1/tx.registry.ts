...
export const MessageComposer = {
  encoded: {
    ...
    setGaslessContracts(value: MsgSetGaslessContracts) {
      return {
        typeUrl: "/cosmwasm.wasm.v1.MsgSetGaslessContracts",
        value: MsgSetGaslessContracts.encode(value).finish()
      };
    }
  },
  withTypeUrl: {
  ...
  fromPartial: {
    ...
    setGaslessContracts(value: MsgSetGaslessContracts) {
      return {
        typeUrl: "/cosmwasm.wasm.v1.MsgSetGaslessContracts",
        value: MsgSetGaslessContracts.fromPartial(value)
      };
    }
  }
};