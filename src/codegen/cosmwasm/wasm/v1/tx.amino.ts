...
export const AminoConverter = {
  ...
  "/cosmwasm.wasm.v1.MsgSetGaslessContracts": {
    aminoType: "wasm/MsgSetGaslessContracts",
    toAmino: MsgSetGaslessContracts.toAmino,
    fromAmino: MsgSetGaslessContracts.fromAmino
  }
};