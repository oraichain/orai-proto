...
export const MessageComposer = {
  encoded: {
    ...
    forceTransfer(value: MsgForceTransfer) {
      return {
        typeUrl: "/cosmwasm.tokenfactory.v1beta1.MsgForceTransfer",
