...
export interface MsgSetMappingEvmAddress {
  /** signer cosmos address */
  signer: string;
  /** public key that we will use to map cosmos to evm. */
  pubkey: string;
}
export interface MsgSetMappingEvmAddressProtoMsg {
  typeUrl: "/cosmos.evm.vm.v1.MsgSetMappingEvmAddress";
  value: Uint8Array;
}
/** MsgSetMappingEvmAddress defines a mapping from cosmos address to evm address. */
export interface MsgSetMappingEvmAddressAmino {
  /** signer cosmos address */
  signer?: string;
  /** public key that we will use to map cosmos to evm. */
  pubkey?: string;
}
export interface MsgSetMappingEvmAddressAminoMsg {
  type: "cosmos-sdk/MsgSetMappingEvmAddress";
  value: MsgSetMappingEvmAddressAmino;
}
/** MsgSetMappingEvmAddress defines a mapping from cosmos address to evm address. */
export interface MsgSetMappingEvmAddressSDKType {
  signer: string;
  pubkey: string;
}
/** MsgSetMappingEvmAddressResponse defines the response value from Msg/SetMappingEvmAddress. */
export interface MsgSetMappingEvmAddressResponse {}
export interface MsgSetMappingEvmAddressResponseProtoMsg {
  typeUrl: "/cosmos.evm.vm.v1.MsgSetMappingEvmAddressResponse";
  value: Uint8Array;
}
/** MsgSetMappingEvmAddressResponse defines the response value from Msg/SetMappingEvmAddress. */
export interface MsgSetMappingEvmAddressResponseAmino {}
export interface MsgSetMappingEvmAddressResponseAminoMsg {
  type: "cosmos-sdk/MsgSetMappingEvmAddressResponse";
  value: MsgSetMappingEvmAddressResponseAmino;
}
/** MsgSetMappingEvmAddressResponse defines the response value from Msg/SetMappingEvmAddress. */
export interface MsgSetMappingEvmAddressResponseSDKType {}
/** MsgDeleteMappingEvmAddress deletes mapping from cosmos address to evm address. */
export interface MsgDeleteMappingEvmAddress {
  /** signer cosmos address */
  signer: string;
}
export interface MsgDeleteMappingEvmAddressProtoMsg {
  typeUrl: "/cosmos.evm.vm.v1.MsgDeleteMappingEvmAddress";
  value: Uint8Array;
}
/** MsgDeleteMappingEvmAddress deletes mapping from cosmos address to evm address. */
export interface MsgDeleteMappingEvmAddressAmino {
  /** signer cosmos address */
  signer?: string;
}
export interface MsgDeleteMappingEvmAddressAminoMsg {
  type: "cosmos-sdk/MsgDeleteMappingEvmAddress";
  value: MsgDeleteMappingEvmAddressAmino;
}
/** MsgDeleteMappingEvmAddress deletes mapping from cosmos address to evm address. */
export interface MsgDeleteMappingEvmAddressSDKType {
  signer: string;
}
/** MsgDeleteMappingEvmAddressResponse defines the response value from Msg/DeleteMappingEvmAddress. */
export interface MsgDeleteMappingEvmAddressResponse {}
export interface MsgDeleteMappingEvmAddressResponseProtoMsg {
  typeUrl: "/cosmos.evm.vm.v1.MsgDeleteMappingEvmAddressResponse";
  value: Uint8Array;
}
/** MsgDeleteMappingEvmAddressResponse defines the response value from Msg/DeleteMappingEvmAddress. */
export interface MsgDeleteMappingEvmAddressResponseAmino {}
export interface MsgDeleteMappingEvmAddressResponseAminoMsg {
  type: "cosmos-sdk/MsgDeleteMappingEvmAddressResponse";
  value: MsgDeleteMappingEvmAddressResponseAmino;
}
/** MsgDeleteMappingEvmAddressResponse defines the response value from Msg/DeleteMappingEvmAddress. */
export interface MsgDeleteMappingEvmAddressResponseSDKType {}
...
function createBaseMsgSetMappingEvmAddress(): MsgSetMappingEvmAddress {
  return {
    signer: "",
    pubkey: ""
  };
}
export const MsgSetMappingEvmAddress = {
  typeUrl: "/cosmos.evm.vm.v1.MsgSetMappingEvmAddress",
  encode(message: MsgSetMappingEvmAddress, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.signer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSetMappingEvmAddress {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgSetMappingEvmAddress();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: Partial<MsgSetMappingEvmAddress>): MsgSetMappingEvmAddress {
    const message = createBaseMsgSetMappingEvmAddress();
    message.signer = object.signer ?? "";
    message.pubkey = object.pubkey ?? "";
    return message;
  },
  fromAmino(object: MsgSetMappingEvmAddressAmino): MsgSetMappingEvmAddress {
    const message = createBaseMsgSetMappingEvmAddress();
  ...
  toAmino(message: MsgSetMappingEvmAddress): MsgSetMappingEvmAddressAmino {
    const obj: any = {};
    obj.signer = message.signer === "" ? undefined : message.signer;
    obj.pubkey = message.pubkey === "" ? undefined : message.pubkey;
    return obj;
  },
  fromAminoMsg(object: MsgSetMappingEvmAddressAminoMsg): MsgSetMappingEvmAddress {
    return MsgSetMappingEvmAddress.fromAmino(object.value);
  },
  toAminoMsg(message: MsgSetMappingEvmAddress): MsgSetMappingEvmAddressAminoMsg {
    return {
      type: "cosmos-sdk/MsgSetMappingEvmAddress",
      value: MsgSetMappingEvmAddress.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgSetMappingEvmAddressProtoMsg): MsgSetMappingEvmAddress {
    return MsgSetMappingEvmAddress.decode(message.value);
  },
  toProto(message: MsgSetMappingEvmAddress): Uint8Array {
    return MsgSetMappingEvmAddress.encode(message).finish();
  },
  toProtoMsg(message: MsgSetMappingEvmAddress): MsgSetMappingEvmAddressProtoMsg {
    return {
      typeUrl: "/cosmos.evm.vm.v1.MsgSetMappingEvmAddress",
      value: MsgSetMappingEvmAddress.encode(message).finish()
    };
  }
};
function createBaseMsgSetMappingEvmAddressResponse(): MsgSetMappingEvmAddressResponse {
  return {};
}
export const MsgSetMappingEvmAddressResponse = {
  typeUrl: "/cosmos.evm.vm.v1.MsgSetMappingEvmAddressResponse",
  encode(_: MsgSetMappingEvmAddressResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSetMappingEvmAddressResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgSetMappingEvmAddressResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(_: Partial<MsgSetMappingEvmAddressResponse>): MsgSetMappingEvmAddressResponse {
    const message = createBaseMsgSetMappingEvmAddressResponse();
    return message;
  },
  fromAmino(_: MsgSetMappingEvmAddressResponseAmino): MsgSetMappingEvmAddressResponse {
    const message = createBaseMsgSetMappingEvmAddressResponse();
    return message;
  },
  toAmino(_: MsgSetMappingEvmAddressResponse): MsgSetMappingEvmAddressResponseAmino {
    const obj: any = {};
    return obj;
  },
  fromAminoMsg(object: MsgSetMappingEvmAddressResponseAminoMsg): MsgSetMappingEvmAddressResponse {
    return MsgSetMappingEvmAddressResponse.fromAmino(object.value);
  },
  toAminoMsg(message: MsgSetMappingEvmAddressResponse): MsgSetMappingEvmAddressResponseAminoMsg {
    return {
      type: "cosmos-sdk/MsgSetMappingEvmAddressResponse",
      value: MsgSetMappingEvmAddressResponse.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgSetMappingEvmAddressResponseProtoMsg): MsgSetMappingEvmAddressResponse {
    return MsgSetMappingEvmAddressResponse.decode(message.value);
  },
  toProto(message: MsgSetMappingEvmAddressResponse): Uint8Array {
    return MsgSetMappingEvmAddressResponse.encode(message).finish();
  },
  toProtoMsg(message: MsgSetMappingEvmAddressResponse): MsgSetMappingEvmAddressResponseProtoMsg {
    return {
      typeUrl: "/cosmos.evm.vm.v1.MsgSetMappingEvmAddressResponse",
...
function createBaseMsgDeleteMappingEvmAddress(): MsgDeleteMappingEvmAddress {
  return {
    signer: ""
  };
}
export const MsgDeleteMappingEvmAddress = {
  typeUrl: "/cosmos.evm.vm.v1.MsgDeleteMappingEvmAddress",
  encode(message: MsgDeleteMappingEvmAddress, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.signer !== "") {
      writer.uint32(10).string(message.signer);
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeleteMappingEvmAddress {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgDeleteMappingEvmAddress();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: Partial<MsgDeleteMappingEvmAddress>): MsgDeleteMappingEvmAddress {
    const message = createBaseMsgDeleteMappingEvmAddress();
    message.signer = object.signer ?? "";
    return message;
  },
  fromAmino(object: MsgDeleteMappingEvmAddressAmino): MsgDeleteMappingEvmAddress {
    const message = createBaseMsgDeleteMappingEvmAddress();
    if (object.signer !== undefined && object.signer !== null) {
      message.signer = object.signer;
    }
  ...
  toAmino(message: MsgDeleteMappingEvmAddress): MsgDeleteMappingEvmAddressAmino {
    const obj: any = {};
    obj.signer = message.signer === "" ? undefined : message.signer;
    return obj;
  },
  fromAminoMsg(object: MsgDeleteMappingEvmAddressAminoMsg): MsgDeleteMappingEvmAddress {
    return MsgDeleteMappingEvmAddress.fromAmino(object.value);
  },
  toAminoMsg(message: MsgDeleteMappingEvmAddress): MsgDeleteMappingEvmAddressAminoMsg {
    return {
      type: "cosmos-sdk/MsgDeleteMappingEvmAddress",
      value: MsgDeleteMappingEvmAddress.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgDeleteMappingEvmAddressProtoMsg): MsgDeleteMappingEvmAddress {
    return MsgDeleteMappingEvmAddress.decode(message.value);
  },
  toProto(message: MsgDeleteMappingEvmAddress): Uint8Array {
    return MsgDeleteMappingEvmAddress.encode(message).finish();
  },
  toProtoMsg(message: MsgDeleteMappingEvmAddress): MsgDeleteMappingEvmAddressProtoMsg {
    return {
      typeUrl: "/cosmos.evm.vm.v1.MsgDeleteMappingEvmAddress",
      value: MsgDeleteMappingEvmAddress.encode(message).finish()
    };
  }
};
function createBaseMsgDeleteMappingEvmAddressResponse(): MsgDeleteMappingEvmAddressResponse {
  return {};
}
export const MsgDeleteMappingEvmAddressResponse = {
  typeUrl: "/cosmos.evm.vm.v1.MsgDeleteMappingEvmAddressResponse",
  encode(_: MsgDeleteMappingEvmAddressResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeleteMappingEvmAddressResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgDeleteMappingEvmAddressResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(_: Partial<MsgDeleteMappingEvmAddressResponse>): MsgDeleteMappingEvmAddressResponse {
    const message = createBaseMsgDeleteMappingEvmAddressResponse();
    return message;
  },
  fromAmino(_: MsgDeleteMappingEvmAddressResponseAmino): MsgDeleteMappingEvmAddressResponse {
    const message = createBaseMsgDeleteMappingEvmAddressResponse();
    return message;
  },
  toAmino(_: MsgDeleteMappingEvmAddressResponse): MsgDeleteMappingEvmAddressResponseAmino {
    const obj: any = {};
    return obj;
  },
  fromAminoMsg(object: MsgDeleteMappingEvmAddressResponseAminoMsg): MsgDeleteMappingEvmAddressResponse {
    return MsgDeleteMappingEvmAddressResponse.fromAmino(object.value);
  },
  toAminoMsg(message: MsgDeleteMappingEvmAddressResponse): MsgDeleteMappingEvmAddressResponseAminoMsg {
    return {
      type: "cosmos-sdk/MsgDeleteMappingEvmAddressResponse",
      value: MsgDeleteMappingEvmAddressResponse.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgDeleteMappingEvmAddressResponseProtoMsg): MsgDeleteMappingEvmAddressResponse {
    return MsgDeleteMappingEvmAddressResponse.decode(message.value);
  },
  toProto(message: MsgDeleteMappingEvmAddressResponse): Uint8Array {
    return MsgDeleteMappingEvmAddressResponse.encode(message).finish();
  },
  toProtoMsg(message: MsgDeleteMappingEvmAddressResponse): MsgDeleteMappingEvmAddressResponseProtoMsg {
    return {
      typeUrl: "/cosmos.evm.vm.v1.MsgDeleteMappingEvmAddressResponse",
      value: MsgDeleteMappingEvmAddressResponse.encode(message).finish()
    };
  }
};