...
import { QueryAccountRequest, QueryAccountResponse, QueryCosmosAccountRequest, QueryCosmosAccountResponse, QueryValidatorAccountRequest, QueryValidatorAccountResponse, QueryBalanceRequest, QueryBalanceResponse, QueryStorageRequest, QueryStorageResponse, QueryCodeRequest, QueryCodeResponse, QueryParamsRequest, QueryParamsResponse, EthCallRequest, EstimateGasResponse, QueryTraceTxRequest, QueryTraceTxResponse, QueryTraceBlockRequest, QueryTraceBlockResponse, QueryMappedEvmAddressRequest, QueryMappedEvmAddressResponse, QueryMappedCosmosAddressRequest, QueryMappedCosmosAddressResponse, QueryBaseFeeRequest, QueryBaseFeeResponse, QueryConfigRequest, QueryConfigResponse, QueryGlobalMinGasPriceRequest, QueryGlobalMinGasPriceResponse } from "./query";
...
export interface Query {
  ...
  mappedEvmAddress(request: QueryMappedEvmAddressRequest): Promise<QueryMappedEvmAddressResponse>;
  mappedCosmosAddress(request: QueryMappedCosmosAddressRequest): Promise<QueryMappedCosmosAddressResponse>;
  /**
...
export class QueryClientImpl implements Query {
  ...
  mappedEvmAddress(request: QueryMappedEvmAddressRequest): Promise<QueryMappedEvmAddressResponse> {
    const data = QueryMappedEvmAddressRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.evm.vm.v1.Query", "MappedEvmAddress", data);
    return promise.then(data => QueryMappedEvmAddressResponse.decode(new BinaryReader(data)));
  }
  mappedCosmosAddress(request: QueryMappedCosmosAddressRequest): Promise<QueryMappedCosmosAddressResponse> {
    const data = QueryMappedCosmosAddressRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.evm.vm.v1.Query", "MappedCosmosAddress", data);
    return promise.then(data => QueryMappedCosmosAddressResponse.decode(new BinaryReader(data)));
  }
  baseFee(request: QueryBaseFeeRequest = {}): Promise<QueryBaseFeeResponse> {
...
export const createRpcQueryExtension = (base: QueryClient) => {
  ...
  return {
    ...
    mappedEvmAddress(request: QueryMappedEvmAddressRequest): Promise<QueryMappedEvmAddressResponse> {
      return queryService.mappedEvmAddress(request);
    },
    mappedCosmosAddress(request: QueryMappedCosmosAddressRequest): Promise<QueryMappedCosmosAddressResponse> {
      return queryService.mappedCosmosAddress(request);
    },
    baseFee(request?: QueryBaseFeeRequest): Promise<QueryBaseFeeResponse> {
