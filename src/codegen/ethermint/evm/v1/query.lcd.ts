...
export class LCDQueryClient {
  ...
  /* MappedEvmAddress */
  async mappedEvmAddress(params: QueryMappedEvmAddressRequest): Promise<QueryMappedEvmAddressResponseSDKType> {
    const options: any = {
      params: {}
    };
    if (typeof params?.cosmosAddress !== "undefined") {
      options.params.cosmosAddress = params.cosmosAddress;
    }
    const endpoint = `ethermint/evm/v1/mapped-evm-address`;
    return await this.req.get<QueryMappedEvmAddressResponseSDKType>(endpoint, options);
  }
  /* MappedCosmosAddress */
  async mappedCosmosAddress(params: QueryMappedCosmosAddressRequest): Promise<QueryMappedCosmosAddressResponseSDKType> {
    const options: any = {
      params: {}
    };
    if (typeof params?.evmAddress !== "undefined") {
      options.params.evmAddress = params.evmAddress;
    }
    const endpoint = `ethermint/evm/v1/mapped-cosmos-address`;
    return await this.req.get<QueryMappedCosmosAddressResponseSDKType>(endpoint, options);
  }
